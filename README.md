...
You can directly use the `go` tool in the root of the cloned repository to install
the `prometheus` and `promtool` binaries into your `GOPATH`:
...
You can also build using `make build`, which will compile in
